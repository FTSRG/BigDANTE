...
output$plot = renderPlot({
  if (input$algo == "lof") {
    ...
    base <- ggplot(d)
    base <- base + geom_point(aes(x = x, y = y,  col = colors, size = 1.5)) +
  ...
  ###########################convex###################################
    ...
    convex_result <<- b
    base <- ggplot()
    base <- base + geom_point(data = d, aes(x = x, y = y, size = 1.5)) +
  ...
  ############################### db #################################
    ...
    if (sum(d$color) == length(d[,1])) {
        base <- base + geom_point(data = d, aes(x = x, y = y, size = 1.5), color = "#CC3300") +
        scale_colour_manual(values=cbPalette)+ theme_bw() +
          ##xlim(c(-10, 10)) +
          ###ylim(c(-10, 10)) +
          theme(legend.position = "none", text = element_text(face = "bold"))
    } else {
        base <- base + geom_point(data = d, aes(x = x, y = y, color = color, size = 1.5)) +
        scale_colour_manual(values=cbPalette)+ theme_bw() +
          ##xlim(c(-10, 10)) +
          ###ylim(c(-10, 10)) +
          theme(legend.position = "none", text = element_text(face = "bold"))
  ...
  ################################bacon################################
      ...
      if(input$mansel == "manual" & length(unique(d$color)) == 2) {
        ...
        if(any(unique(d$color) == 0)) {
          base <- ggplot()
          base <- base + geom_point(data = d, aes(x = x, y = y, color = as.factor(color), size = 1.5)) +
            scale_colour_manual(values = c("#99CC33", "#FFCC33"))+ theme_bw() +
            ##xlim(c(-10, 10)) +
            ###ylim(c(-10, 10)) +
            theme(legend.position = "none", text = element_text(face = "bold"))
          print(base)
          ...
          base <- ggplot()
          base <- base + geom_point(data = d, aes(x = x, y = y, color = as.factor(color), size = 1.5)) +
            scale_colour_manual(values = c("#CC3300", "#FFCC33"))+ theme_bw() +
            ##xlim(c(-10, 10)) +
            ###ylim(c(-10, 10)) +
            theme(legend.position = "none", text = element_text(face = "bold"))
          print(base)
        ...
        if (length(unique(d$color)) == 2) {
          ...
          base <- ggplot()
          base <- base + geom_point(data = d, aes(x = x, y = y, color = as.factor(color), size = 1.5)) +
            scale_colour_manual(values = c("#99CC33", "#CC3300"))+ theme_bw() +
            ##xlim(c(-10, 10)) +
            ###ylim(c(-10, 10)) +
            theme(legend.position = "none", text = element_text(face = "bold"))
          print(base)
  ...
  #####################################################################
    ...
    base <- ggplot(d)
    base <- base + geom_point(aes(x = x, y = y, size = 1.5)) + theme_bw() +
      ##xlim(c(-10, 10)) +
      ###ylim(c(-10, 10)) +
      theme(legend.position = "none", text = element_text(face = "bold"))
    print(base)
